                ...
                <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                    <div className="lg:pr-4">
                        <div className="lg:max-w-lg">
                            <p className="text-base font-semibold leading-7 text-indigo-600">Art Authentication</p>
                        ...
                        <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                            ...
                            <ul role="list" className="mt-8 space-y-8 text-gray-600">
                                <li className="flex gap-x-3">
                                    ...
                                    <span>
                                        <strong className="font-semibold text-gray-900">Step 1: Register Your Artwork</strong> — Upload your artwork to our platform. Each piece will be assigned a digital certificate of authenticity stored securely on the blockchain.
                                    </span>
                                </li>
                                <li className="flex gap-x-3">
                                    <LockClosedIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                                    <span>
                                        <strong className="font-semibold text-gray-900">Step 2: Attach NFC Tag</strong> — Attach an NFC tag to the physical piece. This tag is cryptographically linked to the digital certificate, allowing easy verification.
                                    </span>
                                </li>
                                <li className="flex gap-x-3">
                                    <ServerCogIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                                    <span>
                                        <strong className="font-semibold text-gray-900">Step 3: Verify and Share</strong> — Buyers, collectors, and galleries can easily verify authenticity by scanning the NFC tag, confirming ownership and provenance.
                                    </span>
                                </li>
                            </ul>
                            <p className="mt-8">
                            ...
                            <h2 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">Why Choose Our Platform?</h2>
                            <p className="mt-6">
